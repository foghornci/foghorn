...
var actionsResource = schema.GroupVersionResource{Group: "foghorn", Version: "v1alpha1", Resource: "actions"}

var actionsKind = schema.GroupVersionKind{Group: "foghorn", Version: "v1alpha1", Kind: "Action"}
