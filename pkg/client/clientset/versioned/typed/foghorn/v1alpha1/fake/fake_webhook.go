...
var webhooksResource = schema.GroupVersionResource{Group: "foghorn", Version: "v1alpha1", Resource: "webhooks"}

var webhooksKind = schema.GroupVersionKind{Group: "foghorn", Version: "v1alpha1", Kind: "Webhook"}
