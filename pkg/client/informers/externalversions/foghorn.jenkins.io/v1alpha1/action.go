	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FoghornV1alpha1().Actions(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FoghornV1alpha1().Actions(namespace).Watch(options)
			},
		},
		&foghornjenkinsiov1alpha1.Action{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *actionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foghornjenkinsiov1alpha1.Action{}, f.defaultInformer)
}
