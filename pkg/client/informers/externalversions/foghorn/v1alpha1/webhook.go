...
import (
	...
	v1alpha1 "github.com/foghornci/foghorn/pkg/client/listers/foghorn/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FoghornV1alpha1().Webhooks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FoghornV1alpha1().Webhooks(namespace).Watch(options)
			},
		},
		&foghornv1alpha1.Webhook{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *webhookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&foghornv1alpha1.Webhook{}, f.defaultInformer)
}
